    ...
    <dialog ref={dialogRef} className="modal">
      <div className="modal-box mt-auto mb-0 flex max-w-md flex-col p-0">
        ...
        <div className="flex flex-col items-center gap-3 px-6 pt-5 pb-6">
          ...
          <button
            type="button"
            className="btn btn-accent start-btn-glow w-full rounded-2xl py-7 font-bold text-2xl tracking-wide shadow-accent/30 shadow-xl transition-all duration-200 hover:shadow-2xl hover:shadow-accent/40 active:scale-[0.97]"
            onClick={() => {
