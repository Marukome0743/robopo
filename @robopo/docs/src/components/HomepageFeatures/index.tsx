...
const FeatureList: FeatureItem[] = [
  {
    title: "採点機能",
    src: require("@site/static/screens/04-scoring/scoring-basic.png").default,
    url: "/docs/category/採点者向け",
    description: <>タブレットやスマホで競技の採点をリアルタイムに行えます。</>,
  },
  {
    title: "集計結果表示",
    src: require("@site/static/screens/05-results/summary.png").default,
    url: "/docs/category/集計・印刷",
    description: <>選手・採点者・コース別に結果を一覧表示、PDF出力できます。</>,
  },
  {
    title: "大会運営",
    src: require("@site/static/screens/03-admin/dashboard.png").default,
